...
class ClassContent extends Model
{
    ...
    protected $fillable = [
        'id','class_id', 'title', 'thumbnail', 'content', 'level', 'duration', 'documents', 'start_date', 'end_date', 'author', 'is_done', 'is_approve',
    ];
    protected $hidden = [];
    ...
    // 1 nội dung chỉ thuộc về 1 và chỉ 1 Lớp Class NtqClass
